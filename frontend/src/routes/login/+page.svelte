...
>
	<main class="flex w-full max-w-md flex-col gap-6 border border-black p-6 dark:border-white">
		...
		<button
			type="button"
			class="flex flex-row items-center gap-2 border border-black bg-stone-100 px-4 py-2 text-black transition-none hover:bg-black hover:text-white dark:border-white dark:bg-stone-950 dark:text-white dark:hover:bg-white dark:hover:text-black"
