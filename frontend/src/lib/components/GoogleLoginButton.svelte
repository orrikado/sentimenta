...
<button
	type="button"
	class="flex w-full items-center justify-center gap-2 border border-black bg-stone-100 px-4 py-2 text-black transition-none hover:bg-black hover:text-white dark:border-white dark:bg-stone-950 dark:text-white dark:hover:bg-white dark:hover:text-black"
